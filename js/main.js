...
const DATA = {
  ...
  profile: {
    ...
    bio: '一名专注于 AIGC 商业视觉创作的创作者，致力于将 AI 生成能力与品牌视觉需求结合，在电商产品图、品牌 IP 设定、TVC 广告、数字人口播与动态漫剧等方向持续探索，能独立完成从概念生成、细节优化到后期整合的全流程创作。\n\n善于整理常用 AI 提示词、风格参考、分镜结构、镜头语言模板、产品展示逻辑与素材生成规范，结合多种AI工具提升内容生产效率，增强项目画面稳定性、风格一致性与交付可控性。',
    skills: [
  ...
  ecommerce: [
    {
      ...
      mainImages: [
        { src: 'assets/ecommerce/set1/main-1.png', label: '主图 1' },
        { src: 'assets/ecommerce/set1/main-2.png', label: '主图 2' },
        { src: 'assets/ecommerce/set1/main-3.png', label: '主图 3' },
        { src: 'assets/ecommerce/set1/main-4.png', label: '主图 4' },
        { src: 'assets/ecommerce/set1/main-5.png', label: '主图 5' },
      ],
      detailImage: { src: 'assets/ecommerce/set1/detail.jpg', label: '详情页长图' },
      banners: [
        { src: 'assets/ecommerce/set1/banner-1.png', label: 'Banner 海报 1' },
        { src: 'assets/ecommerce/set1/banner-2.png', label: 'Banner 海报 2' },
      ],
      posters: [
        { src: 'assets/ecommerce/set1/poster-1.png', label: '宣传海报 1' },
        { src: 'assets/ecommerce/set1/poster-2.png', label: '宣传海报 2' },
      ]
    },
    {
      id: 'eco-2',
      ...
      mainImages: [
        { src: 'assets/ecommerce/set2/main-1.png', label: '主图 1' },
        { src: 'assets/ecommerce/set2/main-2.png', label: '主图 2' },
        { src: 'assets/ecommerce/set2/main-3.png', label: '主图 3' },
        { src: 'assets/ecommerce/set2/main-4.png', label: '主图 4' },
        { src: 'assets/ecommerce/set2/main-5.png', label: '主图 5' },
      ],
      detailImage: { src: 'assets/ecommerce/set2/detail.png', label: '详情页长图' },
      banners: [
        { src: 'assets/ecommerce/set2/banner-1.png', label: 'Banner 海报 1' },
        { src: 'assets/ecommerce/set2/banner-2.png', label: 'Banner 海报 2' },
      ],
      posters: [
        { src: 'assets/ecommerce/set2/poster-1.png', label: '宣传海报 1' },
        { src: 'assets/ecommerce/set2/poster-2.png', label: '宣传海报 2' },
      ]
    },
    {
      id: 'eco-3',
      ...
      mainImages: [
        { src: 'assets/ecommerce/set3/main-1.png', label: '主图 1' },
        { src: 'assets/ecommerce/set3/main-2.png', label: '主图 2' },
        { src: 'assets/ecommerce/set3/main-3.png', label: '主图 3' },
        { src: 'assets/ecommerce/set3/main-4.png', label: '主图 4' },
        { src: 'assets/ecommerce/set3/main-5.png', label: '主图 5' },
      ],
      detailImage: [
        { src: 'assets/ecommerce/set3/detail-1.png', label: '详情页 1' },
        { src: 'assets/ecommerce/set3/detail-2.png', label: '详情页 2' },
        { src: 'assets/ecommerce/set3/detail-3.png', label: '详情页 3' },
        { src: 'assets/ecommerce/set3/detail-4.png', label: '详情页 4' },
        { src: 'assets/ecommerce/set3/detail-5.png', label: '详情页 5' },
      ],
      banners: [
        { src: 'assets/ecommerce/set3/banner-1.png', label: 'Banner 海报 1' },
        { src: 'assets/ecommerce/set3/banner-2.png', label: 'Banner 海报 2' },
      ],
      posters: [
        { src: 'assets/ecommerce/set3/poster-1.png', label: '宣传海报 1' },
        { src: 'assets/ecommerce/set3/poster-2.png', label: '宣传海报 2' },
      ]
    },
    {
      id: 'eco-4',
      ...
      hideScrollHint: true,
      mainImages: [
        { src: 'assets/ecommerce/set4/main-1.png', label: '主图 1' },
        { src: 'assets/ecommerce/set4/main-2.png', label: '主图 2' },
        { src: 'assets/ecommerce/set4/main-3.png', label: '主图 3' },
        { src: 'assets/ecommerce/set4/main-4.png', label: '主图 4' },
      ...
      banners: [
        ...
        { src: 'assets/ecommerce/set4/banner-3.png', label: 'Banner 海报 3' },
        { src: 'assets/ecommerce/set4/banner-4.png', label: 'Banner 海报 4' },
        { src: 'assets/ecommerce/set4/banner-5.png', label: 'Banner 海报 5' },
      ],
      posters: []
    }
  ],
  ...
  tvc: [
    { id: 'tvc-1', title: '口红 TVC', desc: 'AI生成口红产品广告 · 9:16 竖版', ratio: '9:16', src: 'assets/tvc/tvc-1.mp4', poster: 'assets/tvc/poster-1.png' },
    { id: 'tvc-2', title: '香薰 TVC', desc: 'AI生成香薰产品广告 · 9:16 竖版', ratio: '9:16', src: 'assets/tvc/tvc-2.mp4', poster: 'assets/tvc/poster-2.png' },
    { id: 'tvc-3', title: '电煮锅 TVC', desc: 'AI生成电煮锅产品广告 · 9:16 竖版', ratio: '9:16', src: 'assets/tvc/tvc-3.mp4', poster: 'assets/tvc/poster-3.png' },
    { id: 'tvc-4', title: '无线耳机 TVC', desc: 'AI生成无线耳机产品广告 · 9:16 竖版', ratio: '9:16', src: 'assets/tvc/tvc-4.mp4', poster: 'assets/tvc/poster-4.png' },
    { id: 'tvc-5', title: '游戏手柄 TVC', desc: 'AI生成游戏手柄产品广告 · 16:9 横版', ratio: '16:9', src: 'assets/tvc/tvc-5.mp4', poster: 'assets/tvc/poster-5.png' },
    { id: 'tvc-6', title: '冰红茶 TVC', desc: 'AI生成冰红茶产品广告 · 16:9 横版', ratio: '16:9', src: 'assets/tvc/tvc-6.mp4', poster: 'assets/tvc/poster-6.png' },
    { id: 'tvc-7', title: '苹果 TVC', desc: 'AI生成苹果产品广告 · 16:9 横版', ratio: '16:9', src: 'assets/tvc/tvc-7.mp4', poster: 'assets/tvc/poster-7.png' },
    { id: 'tvc-8', title: '曲奇 TVC', desc: 'AI生成曲奇产品广告 · 16:9 横版', ratio: '16:9', src: 'assets/tvc/tvc-8.mp4', poster: 'assets/tvc/poster-8.png' },
  ],
